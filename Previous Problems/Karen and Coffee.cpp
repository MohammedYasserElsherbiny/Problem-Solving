...
int main()
{
    ...
    while (tt--)
    {
        ...
        For(i, 1, N) inters[i] += vec[i] + inters[i - 1];
        ...
        For(i, 1, N) pre[i] += inters[i] + pre[i - 1];
...
https://codeforces.com/group/fOSxgJrX1P/contest/662586/problem/E
